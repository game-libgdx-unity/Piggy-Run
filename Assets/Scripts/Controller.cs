...
//		public void fetch_device(int front)
//		{
//			float hori = InputManager.Instance.getAnalog(front, InputManager.Button.Horizontal);
//			horizontal_ = (int)(hori*127);
//			left_button_ = InputManager.Instance.isButton(front, InputManager.Button.Left);
//			right_button_ = InputManager.Instance.isButton(front, InputManager.Button.Right);
//			jump_button_ = InputManager.Instance.isButton(front, InputManager.Button.Jump);

//			if (InputManager.Instance.touched(front, 0 /* index */)) {
//				var touched_position0 = InputManager.Instance.getTouchedPosition(front, 0 /* index */);
...
//					}
//				}
//				if (InputManager.Instance.touched(front, 1 /* index */)) {
//					var touched_position1 = InputManager.Instance.getTouchedPosition(front, 1 /* index */);
...
//		public void fetch_pause_button(int front)
//		{
//            if (InputManager.Instance.touched(front, 0 /* index */)) {
//                var touched_position0 = InputManager.Instance.getTouchedPosition(front, 0 /* index */);
//                if (Mathf.Abs(touched_position0.x) < Screen.width * 0.25f &&
//                    Mathf.Abs(touched_position0.y) < Screen.height * 0.25f) {
//                    pause_button_ = true;
//                } else {
//                    pause_button_ = false;
//                }
...
//	public void fetch(int front, double update_time)
//	{
...
//		latest_.clear();
//		latest_.fetch_pause_button(front);
//		if (enumerator_ != null) {
//			update_time_ = update_time;
//			fetch_auto_update();
//			enumerator_.MoveNext();
//		} else {
//			latest_.fetch_device(front);
//		}
